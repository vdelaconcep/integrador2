...
const reglasValidacionMensajes = [
    ...
    check("asunto")
        .escape()
        .notEmpty().withMessage("El asunto no puede quedar vacío")
        .bail()
        .isLength({ max: 40 }).withMessage("El asunto puede tener 40 caracteres como máximo"),
    
    check("mensaje")
        .escape()
        .notEmpty().withMessage("El mensaje no puede quedar vacío")
        .bail()
        .isLength({ max: 240 }).withMessage("El mensaje puede tener hasta 240 caracteres")
];
